...
var enemySound = new Audio('sounds/lossbeep.wav');
...
for (var f = 0; f < 5; f++) {
	...
	//Play the Loss Beep when the player hits the Fire Trap
	enemySound.play();
    }
}
...
for (var ws = 0; ws < 5; ws++) {
	...
	//Play the Collectable Sound when the player hits the Water Spell
